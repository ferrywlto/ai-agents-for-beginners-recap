This is a fork from https://github.com/microsoft/ai-agents-for-beginners

The README of each chapter was generated by summerising the original contents using GPT-4.5. 

The aim of this fork is to make the lessons more easier to understand for visual learner like myself:
- It use table, point forms and emojis to reduce the length of text, the original content text is not very intutive.
- It use mermaid charts to explain workflow instead of code blocks, as the code in original content looks pretty much pseudocode.
- It also has a Cantonese [translation](./translations/hk/README.md) for HongKongers 🇭🇰. Please feel free to add your translation as needed.
